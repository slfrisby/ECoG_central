...
channelDetails(3).BadElectrode = {'B01'};
...
channelDetails(4).BadElectrode = {'B01';'B06';'B11'};
channelDetails(4).BadElectrodeStatusDescription = {'seizure onset zone'; 'seizure onset zone'; 'seizure onset zone'};
...
channelDetails(5).BadElectrode = {'A01';'A02';'A06';'A07'};
channelDetails(5).BadElectrodeStatusDescription = {'seizure onset zone'; 'seizure onset zone'; 'seizure onset zone'; 'seizure onset zone'};
...
channelDetails(9).BadElectrode = {'D19'};
channelDetails(9).BadElectrodeStatusDescription = {'seizure onset zone'};
...
channelDetails(10).BadElectrode = {'B05';'B06';'B07';'B13';'B14';'B15';'B16';'C11';'C12';'C16';'C17'};
channelDetails(10).BadElectrodeStatusDescription = {'seizure onset zone'; 'seizure onset zone'; 'seizure onset zone'; 'seizure onset zone'; 'seizure onset zone'; 'seizure onset zone'; 'seizure onset zone'; 'seizure onset zone'; 'seizure onset zone'; 'seizure onset zone'; 'seizure onset zone'};
...
channelDetails(12).BadElectrode = {'C06';'C11'};
channelDetails(12).BadElectrodeStatusDescription = {'seizure onset zone'; 'seizure onset zone'};
...
channelDetails(18).BadElectrode = {'C01';'C02';'C03';'C04';'C05';'C06';'D01';'D02';'D03';'D04';'D05';'D06';'E03';'E06';'E07';'E08';'E11';'E12';'E13';'E14';'E15';'E18';'E20';'F01';'F02';'F03';'F04';'F05';'F07';'F08';'F12';'F13';'G10'};
...
channelDetails(20).Subject = '13';
channelDetails(20).Task = 'semanticjudgement';
channelDetails(20).NotECoG = {'REFA01';'REFA02';'REFA03';'REFA04';'RDEL';'EKG';'DC04';'DC05';'DC06';'DC07';'DC08'};
channelDetails(20).NotECoGType = {'REF';'REF';'REF';'REF';'MISC';'ECG';'TRIG';'TRIG';'TRIG';'TRIG';'TRIG'};
channelDetails(20).BadElectrode = {'D01';'E01'};
channelDetails(20).BadElectrodeStatusDescription = {'seizure onset zone'; 'seizure onset zone'};

channelDetails(21).Subject = '14';
channelDetails(21).Task = 'semanticjudgement';
channelDetails(21).NotECoG = {'REF01';'REF02';'REF03';'REF04';'DC01';'DC02';'DC03';'DC04'};
channelDetails(21).NotECoGType = {'REF';'REF';'REF';'REF';'TRIG';'TRIG';'TRIG';'TRIG'};
channelDetails(21).BadElectrode = {'A01';'A02';'A03';'B01';'B02'};
channelDetails(21).BadElectrodeStatusDescription = {'seizure onset zone'; 'seizure onset zone'; 'seizure onset zone'; 'seizure onset zone'; 'seizure onset zone'};

channelDetails(22).Subject = '15';
channelDetails(22).Task = 'semanticjudgement';
channelDetails(22).NotECoG = {'REF01';'REF02';'REF03';'REF04';'EKG1';'DC01';'DC02';'DC03'};
channelDetails(22).NotECoGType = {'REF';'REF';'REF';'REF';'ECG';'TRIG';'TRIG';'TRIG'};
channelDetails(22).BadElectrode = {'D01'};
